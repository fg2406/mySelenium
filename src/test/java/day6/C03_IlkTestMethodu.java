...
public class C03_IlkTestMethodu {
    ...
    String exceptTitel="amazon";

    if (actualTitel.contains(exceptTitel)){
        System.out.println("amazon testi PASSED");
    }else{
        System.out.println("amazon testi FAILD"); //amazon testi FAILD cikti
    }
   //sonuc passed dedi JUnit kisminda,cunku if gibi kodlar JUnit isi degil javanin isi,adrese gidip geldi calisti passed verdi
        //if kismi faild dedi cunku amazon,A si buyuk olmaliydi,kodlar calisti ama faild
